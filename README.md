...
- **Question Analytics & Item Difficulty**: Teachers can view all student submissions, average scores, and an itemized breakdown showing which questions students got wrong most often.
...
- **Missed Quiz Tracker**: Identifies any student who did not submit an attempt for a quiz after the window has closed, allowing Nour to contact parents or schedule makeups.
- **Exportable Roster**: Full student performance table grouped by class.
...
A comprehensive suite of 18 automated tests covers scoring formulas, database constraints, and authentication:
